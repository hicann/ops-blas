...
/*!
 * \file matmul_fp32_kernel.cpp
 * \brief FP32 x FP32 -> FP32 matmul kernel and host-side launch wrapper.
 */
...
__global__ __aicore__ void MatmulKernel(
    GM_ADDR aGm, GM_ADDR bGm, GM_ADDR cGm, GM_ADDR dGm, uint32_t m, uint32_t k, uint32_t n)
{
