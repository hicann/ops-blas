...
function(ops_blas_detect_asc_devkit_version)
  ...
  if(EXISTS "${_header}")
    ...
    # arch35 的 strmm/sdgmm/gemm_batched/sgemm3m/ssyrk/ssyr2k/strsmbatched 使用 tensor_api，需 devkit >= 9.1；其他架构不受限
    ...
    set(ENABLE_BLAS_SYR2K FALSE)
    set(ENABLE_BLAS_STRSMBATCHED FALSE)
    message(WARNING "asc_devkit_version.h not found: ${_header}, MXFP8/TRMM/SDGMM/GEMM_BATCHED/GEMM3M/SYRK/SYR2K/STRSMBATCHED will be skipped")
  endif()
