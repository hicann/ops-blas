...
# - STRSMBATCHED：仅 arch35(ascend950) 的 strsmbatched/gemm_strided_batched 使用 tensor_api，需 asc-devkit >= 9.1
function(ops_blas_detect_asc_devkit_version)
  ...
  if(EXISTS "${_header}")
    ...
    # arch35 的 strmm/sdgmm/gemm_batched/sgemm3m/ssyrk/ssyr2k/strsmbatched/gemm_strided_batched 使用 tensor_api，需 devkit >= 9.1；其他架构不受限
    ...
    set(ENABLE_BLAS_STRSMBATCHED FALSE)
    set(ENABLE_BLAS_GEMM_STRIDED_BATCHED FALSE)
    message(WARNING "asc_devkit_version.h not found: ${_header}, MXFP8/TRMM/SDGMM/GEMM_BATCHED/GEMM3M/SYRK/SYR2K/STRSMBATCHED/GEMM_STRIDED_BATCHED will be skipped")
  endif()
  ...
  message(
    STATUS
    "ASC_DEVKIT_MAJOR=${ASC_DEVKIT_MAJOR}, ASC_DEVKIT_MINOR=${ASC_DEVKIT_MINOR}, ENABLE_BLASLT_MXFP8=${ENABLE_BLASLT_MXFP8}, ENABLE_BLAS_TRMM=${ENABLE_BLAS_TRMM}, ENABLE_BLAS_SDGMM=${ENABLE_BLAS_SDGMM}, ENABLE_BLAS_GEMM_BATCHED=${ENABLE_BLAS_GEMM_BATCHED}, ENABLE_BLAS_GEMM3M=${ENABLE_BLAS_GEMM3M}, ENABLE_BLAS_SYRK=${ENABLE_BLAS_SYRK}, ENABLE_BLAS_SYR2K=${ENABLE_BLAS_SYR2K}, ENABLE_BLAS_STRSMBATCHED=${ENABLE_BLAS_STRSMBATCHED}, ENABLE_BLAS_GEMM_STRIDED_BATCHED=${ENABLE_BLAS_GEMM_STRIDED_BATCHED}"
    "ASC_DEVKIT_MAJOR=${ASC_DEVKIT_MAJOR}, ASC_DEVKIT_MINOR=${ASC_DEVKIT_MINOR}, ENABLE_BLASLT_MXFP8=${ENABLE_BLASLT_MXFP8}, ENABLE_BLAS_TRMM=${ENABLE_BLAS_TRMM}, ENABLE_BLAS_SDGMM=${ENABLE_BLAS_SDGMM}, ENABLE_BLAS_GEMM_BATCHED=${ENABLE_BLAS_GEMM_BATCHED}, ENABLE_BLAS_GEMM3M=${ENABLE_BLAS_GEMM3M}, ENABLE_BLAS_SYRK=${ENABLE_BLAS_SYRK}, ENABLE_BLAS_SYR2K=${ENABLE_BLAS_SYR2K}, ENABLE_BLAS_GEMM_STRIDED_BATCHED=${ENABLE_BLAS_GEMM_STRIDED_BATCHED}"
  )
endfunction()
