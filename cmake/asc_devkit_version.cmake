...
function(ops_blas_detect_asc_devkit_version)
  ...
  if(EXISTS "${_header}")
    ...
    # arch35 的 strmm/sdgmm/gemm_batched/sgemm3m/ssyrk/ssyr2k/strsmbatched/gemm_strided_batched/ssyrkx 使用 tensor_api，需 devkit >= 9.1；其他架构不受限
    ...
    set(ENABLE_BLAS_GEMM_STRIDED_BATCHED FALSE)
    set(ENABLE_BLAS_SSYRKX FALSE)
    message(WARNING "asc_devkit_version.h not found: ${_header}, MXFP8/TRMM/SDGMM/GEMM_BATCHED/GEMM3M/SSYRK/SSYR2K/STRSMBATCHED/GEMM_STRIDED_BATCHED/SSYRKX will be skipped")
  endif()
  ...
  message(
    STATUS
    "ASC_DEVKIT_MAJOR=${ASC_DEVKIT_MAJOR}, ASC_DEVKIT_MINOR=${ASC_DEVKIT_MINOR}, ENABLE_BLASLT_MXFP8=${ENABLE_BLASLT_MXFP8}, ENABLE_BLAS_TRMM=${ENABLE_BLAS_TRMM}, ENABLE_BLAS_SDGMM=${ENABLE_BLAS_SDGMM}, ENABLE_BLAS_GEMM_BATCHED=${ENABLE_BLAS_GEMM_BATCHED}, ENABLE_BLAS_GEMM3M=${ENABLE_BLAS_GEMM3M}, ENABLE_BLAS_SSYRK=${ENABLE_BLAS_SSYRK}, ENABLE_BLAS_SSYR2K=${ENABLE_BLAS_SSYR2K}, ENABLE_BLAS_STRSMBATCHED=${ENABLE_BLAS_STRSMBATCHED}, ENABLE_BLAS_GEMM_STRIDED_BATCHED=${ENABLE_BLAS_GEMM_STRIDED_BATCHED}, ENABLE_BLAS_SSYRKX=${ENABLE_BLAS_SSYRKX}"
  )
endfunction()
