...
public:
    ...
    __aicore__ inline void CopyScalesInL1(
        ...
        uint64_t iter0, TensorScaleAL1& tensorScaleAL1, TensorScaleBL1& tensorScaleBL1)
    {
    ...
    __aicore__ inline void CopyAInL1(
        TensorA const& gmA, TileL1L0Param& tileL1L0Param, uint64_t l1BufId, uint64_t iter0, TensorAL1& tensorAL1)
    {
    ...
    template <
        typename TensorAL1, typename TensorBL1, typename TensorScaleAL1, typename TensorScaleBL1, typename TensorBiasL1,
        typename TensorL0C>
    __aicore__ inline void Iterate(
        TileL1L0Param& tileL1L0Param, uint64_t iter0, TensorAL1& tensorAL1, TensorBL1& tensorBL1,
        TensorScaleAL1& tensorScaleAL1, TensorScaleBL1& tensorScaleBL1, TensorBiasL1& tensorBiasL1,
        TensorL0C& tensorL0C)
    {
        ...
        for (uint16_t iter1 = 0; iter1 < kL0Iter; ++iter1) {
            ...
            Mmad(tileL1L0Param, iter0, iter1, kL0Iter, curKL0, tensorAL0, tensorBL0, tensorBt, tensorL0C);
        ...
        TensorBias const& gmBias, TensorC const& gmC, BlockShape const& singleShape)
    {
        ...
        // bisheng AICore 不支持将 MakeMemPtr/MakeTensor 推导类型声明为类成员；在函数体内持有局部 tensor。
        auto layoutPlaceholderScaleZZ = AscendC::Te::MakeFrameLayout<AscendC::Te::ZZLayoutPtn, AscendC::Std::Int<SCALE_C0>>(
            1UL, 1UL);
        auto tensorScaleAL1 = AscendC::Te::MakeTensor(
            AscendC::Te::MakeMemPtr<Location::L1, fp8_e8m0_t>(0), layoutPlaceholderScaleZZ);
        auto layoutPlaceholderScaleNN = AscendC::Te::MakeFrameLayout<AscendC::Te::NNLayoutPtn, AscendC::Std::Int<SCALE_C0>>(
            1UL, 1UL);
        auto tensorScaleBL1 = AscendC::Te::MakeTensor(
            AscendC::Te::MakeMemPtr<Location::L1, fp8_e8m0_t>(0), layoutPlaceholderScaleNN);
        auto layoutPlaceholderA = MakeLayoutAL1{}(1UL, 1UL);
        auto tensorAL1 = AscendC::Te::MakeTensor(AscendC::Te::MakeMemPtr<Location::L1, AType>(0), layoutPlaceholderA);
        auto layoutPlaceholderB = MakeLayoutBL1{}(1UL, 1UL);
        auto tensorBL1 = AscendC::Te::MakeTensor(AscendC::Te::MakeMemPtr<Location::L1, BType>(0), layoutPlaceholderB);
        auto layoutPlaceholderBias = AscendC::Te::FrameLayoutFormat<AscendC::Te::NDExtLayoutPtn>{}(1UL, 1UL);
        auto tensorBiasL1 = AscendC::Te::MakeTensor(
            AscendC::Te::MakeMemPtr<Location::L1, BiasType>(0), layoutPlaceholderBias);
        ...
        auto tensorL0C = AscendC::Te::MakeTensor(AscendC::Te::MakeMemPtr<Location::L0C, float>(l0cOffset), layoutL0C);
        for (uint64_t iter0 = 0; iter0 < kL1Iter_; ++iter0) {
            uint64_t l1BufId = abL1LoopCnt_ & (l1BufNum_ - 1);
            uint64_t scaleL1BufId = scaleLoopCnt_ & 1;

            // scaleA, scaleB GM->L1
            CopyScalesInL1(gmScaleA, gmScaleB, tileL1L0Param, scaleL1BufId, iter0, tensorScaleAL1, tensorScaleBL1);
            ...
            // A GM->L1
            CopyAInL1(gmA, tileL1L0Param, l1BufId, iter0, tensorAL1);
            ...
            Iterate(
                tileL1L0Param, iter0, tensorAL1, tensorBL1, tensorScaleAL1, tensorScaleBL1, tensorBiasL1, tensorL0C);
...
private:
    ...
    template <typename TensorAL0, typename TensorBL0, typename TensorBT, typename TensorL0C>
    __aicore__ inline void Mmad(
        TileL1L0Param& tileL1L0Param, uint64_t iter0, uint64_t iter1, uint64_t kL0Iter, uint64_t curKL0,
        TensorAL0 const& tensorAL0, TensorBL0 const& tensorBL0, TensorBT const& tensorBt, TensorL0C& tensorL0C)
    {
