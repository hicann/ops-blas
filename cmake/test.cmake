...
function(_ops_blas_has_blas_op_sources op_name out_var)
    ...
    if(NOT ENABLE_BLAS_SYRK AND (op_name STREQUAL "ssyrk" OR op_name STREQUAL "syrk"))
        set(${out_var} FALSE PARENT_SCOPE)
        return()
    endif()
    if(NOT ENABLE_BLAS_SYR2K AND (op_name STREQUAL "ssyr2k" OR op_name STREQUAL "syr2k"))
        set(${out_var} FALSE PARENT_SCOPE)
        return()
    endif()
