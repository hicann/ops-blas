...
function(_ops_blas_has_blas_op_sources op_name out_var)
    ...
    if(NOT ENABLE_BLAS_SSYRK AND op_name STREQUAL "ssyrk")
        set(${out_var} FALSE PARENT_SCOPE)
        return()
    endif()
    if(NOT ENABLE_BLAS_SSYR2K AND op_name STREQUAL "ssyr2k")
        set(${out_var} FALSE PARENT_SCOPE)
        return()
    endif()
    if(NOT ENABLE_BLAS_SSYRKX AND op_name STREQUAL "ssyrkx")
        set(${out_var} FALSE PARENT_SCOPE)
        return()
    endif()
    if(NOT ENABLE_BLAS_STRSMBATCHED AND op_name STREQUAL "strsmbatched")
        set(${out_var} FALSE PARENT_SCOPE)
        return()
    endif()
    if(NOT ENABLE_BLAS_GEMM AND op_name STREQUAL "gemm")
        set(${out_var} FALSE PARENT_SCOPE)
        return()
    endif()
