...
int32_t main(int32_t argc, char* argv[])
{
    ...
    std::vector<float> mat = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f};

    std::vector<float> vec = {2.0f, 3.0f, 4.0f, 5.0f};

    std::vector<float> result(m * n * 2);

    std::vector<float> golden = {-4.0f, 7.0f, -6.0f, 17.0f, -8.0f, 27.0f, -12.0f, 67.0f, -14.0f, 85.0f, -16.0f, 103.0f};
    ...
    CHECK_RET(
        statusRet == ACLBLAS_STATUS_SUCCESS, LOG_PRINT("aclblasColwiseMul failed. ERROR: %d\n", statusRet);
        return statusRet);
