...
#ifndef STBSV_PARAM_H
#define STBSV_PARAM_H
...
struct StbsvParam : public BlasTestParamBase {
    ...
    StbsvParam(const csv_map& map) : BlasTestParamBase(map)
    {
        ...
        lda = parseInt(ReadMap(map, "lda", std::to_string(k >= INT_MAX ? INT_MAX : k + 1)));
