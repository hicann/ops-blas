...
> 适用于：`agent/skills/blas-new-op-workflow/assets/*.md`、`agent/skills/blas-new-op-workflow/assets/*.json`

## 修改报告模板（assets/*.md）

1. 修改 `agent/skills/blas-new-op-workflow/assets/<template>.md`
...
1. 修改 `agent/skills/blas-new-op-workflow/assets/CP*.json`
...
1. 修改 `agent/skills/blas-new-op-workflow/assets/LOG.md`
...
```yaml
输入:
  - <模板描述> 模板文件路径 (模板路径: agent/skills/blas-new-op-workflow/assets/<文件名>)
输出:
