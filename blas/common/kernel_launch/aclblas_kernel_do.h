...
void syr_kernel_do(GM_ADDR x, GM_ADDR A, const SyrTilingData &tiling,
                   uint32_t numBlocks, void *stream);
...
void syr2_kernel_do(GM_ADDR x, GM_ADDR y, GM_ADDR A, const Syr2TilingData &tiling,
                     uint32_t numBlocks, void *stream);
...
void tbmv_kernel_do(GM_ADDR a, GM_ADDR x, GM_ADDR y, GM_ADDR workSpace, GM_ADDR tilingGm,
                    uint32_t numBlocks, void *stream);
...
void sgemv_kernel_do(GM_ADDR A, GM_ADDR x, GM_ADDR y, GM_ADDR workSpace, GM_ADDR tilingGm,
                     uint32_t numBlocks, void *stream);
